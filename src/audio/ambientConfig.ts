...
export const AMBIENT_TRACKS: Record<string, AmbientTrack> = {
  ...
  'academy-ambient':   { id: 'academy-ambient',   file: 'academy-ambient.mp3',   label: 'Quiet Study',         baseVolume: 0.3 },
  ...
  'fence-ambient':     { id: 'fence-ambient',     file: 'fence-ambient.mp3',     label: 'Pawn Shop',           baseVolume: 0.3 },
...
// Default ambient volume (0.6 = 60% — ambient should be clearly audible under music)
