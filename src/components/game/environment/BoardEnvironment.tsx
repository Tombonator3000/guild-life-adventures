...
function WorldCanvas({centerPanel, animationLayers}: BoardEnvironmentProps) {
  ...
  useEffect(() => {
    ...
    const scene: Scene={assets,policy,weather:weather?.type,festival:festival??undefined,strike,threeWeather:threeReady};
  ...
  },[manager,assets,policy,weather?.type,festival,strike,centerPanel,animationLayers,threeReady]);
