...
function ScreenCanvas() {
  ...
  useEffect(() => {
    ...
    document.addEventListener('transitionend',measure,true);document.addEventListener('animationend',measure,true);
    resize();
    return () => {unsubscribe();observer.disconnect();mutation.disconnect();window.removeEventListener('resize',resize);document.removeEventListener('scroll',measure,true);document.removeEventListener('transitionend',measure,true);document.removeEventListener('animationend',measure,true);};
