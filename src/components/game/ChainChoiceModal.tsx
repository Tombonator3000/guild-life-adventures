...
import { Swords, Heart, Clock, Coins } from 'lucide-react';
...
export function ChainChoiceModal({ stepName, choices, step, onChoice }: ChainChoiceModalProps) {
  useLocationContentReset(stepName);
  return (
    <section className="guild-quest-choice material-card" aria-label="Choose Your Path">
      <div>
          ...
          {choices.map((choice) => {
            ...
            return (
              <button
                ...
                className="guild-quest-choice-button w-full text-left bg-[#e0d4b8] hover:bg-[#d4c4a8] border border-[#8b7355] hover:border-[#c9a227] rounded p-3 transition-all"
              >
