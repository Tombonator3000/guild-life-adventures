        ...
        <div className="space-y-3">
          <div className="bg-[#e0d4b8] border border-[#8b7355] rounded p-3">
            ...
            <div className="flex justify-between text-sm font-mono mb-3">
              ...
              <span className="font-bold text-[#c9a227]">{getWorkPreview(player, currentJobData.hoursPerShift, week, ctx.activeFestival).net}g</span>
            </div>
...
function forgeTabs(ctx: LocationTabContext): LocationTab[] {
  ...
  const forgeWorkContent = (
    <div className="material-card space-y-2">
      <h3 className="font-display font-bold">Work at the Forge</h3>
      <p className="text-sm">Visit the Guild Hall for career paths, qualifications and job applications.</p>
      <p className="text-sm">Once hired here, return to the Forge to work your shift.</p>
    </div>
  );
