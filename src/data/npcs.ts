...
export const LOCATION_NPCS: Partial<Record<LocationId, LocationNPC>> = {
  ...
  'cave': {
    ...
    greeting: 'The darkness breathes. Something ancient stirs below. Also, there is a smell. An unreasonable smell.',
    bgColor: '#0d0d0d',
    accentColor: '#4a3a5a',
    frameColor: '#1a1020',
    frameDark: '#0d0810',
    frameBorder: '#3a2a4a',
    subtitle: 'The Yawning Dark',
  },
  'forge': {
    name: 'Korr',
    title: 'Smithmaster',
  ...
  'landlord': {
    ...
    greeting: 'Rent is due. It was due yesterday, actually. And the day before that. And now it is due again, which is how time works.',
    bgColor: '#2a2a2a',
    accentColor: '#a1887f',
    frameColor: '#3a3532',
    frameDark: '#2e2a28',
  ...
  'graveyard': {
    ...
    greeting: 'The dead rest here... mostly. Some are just having a really long nap. One complained about the noise.',
    bgColor: '#1a1a1a',
    accentColor: '#6b7b6b',
    frameColor: '#2a3a2a',
    frameDark: '#1a2a1a',
