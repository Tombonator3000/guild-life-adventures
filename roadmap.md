...
- [x] Implement the approved cloud-shadow ground layer on the existing 2D board.
...
- [ ] Add green magical smoke above the Enchanter's cauldron without changing chimney smoke.
- [ ] Verify the cauldron smoke on the actual 2D board.
